...
- Spot cost (this instance): ${inst['spot_cost']:.2f} — projected: ${inst['spot_projected']:.2f} ({inst['savings_pct']:.0f}% savings vs on-demand)
- Total cost across {inst.get('total_sessions', 1)} instance(s): ${inst.get('total_run_cost', inst['spot_cost']):.2f}
