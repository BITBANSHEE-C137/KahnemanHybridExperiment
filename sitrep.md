# Sitrep — 2026-03-04 9:00 PM ET / 02:00 UTC

## v2 Training — running, healthy, 26% complete

- **Step ~12,800 / 50,000** (25.6%)
- GPU: 100% utilization, 16.3 / 22 GB VRAM, 55°C
- Rate: ~828 steps/hr (4.3s/step)
- ETA to 50k: ~44.8 hours at current rate
- Spot price: $0.4377/hr (g5.2xlarge)
- Spot cost (this instance): $0.59 — projected: $2.29
- Total cost across 8 instance(s): $8.64
- Instance up 1h20m since bootstrap (2026-03-05 00:39 UTC) — spot recovery from prior instance (checkpoint restored from S3)
...
Live at step ~12,800: ar_loss 3.33, diff_loss 3.71, conf_acc 0.000
...
| 8 | us-east-1f | 12,300→12,700 | 2026-03-05 00:39 | $0.55 |

**Total spot cost across all instances: $8.60**

## Code & infra

- All services healthy: sync daemon, nginx, Flask dashboard, spot price cron
- Checkpoints on disk: step_10000.pt, step_11000.pt, step_12000.pt (all synced to S3)
